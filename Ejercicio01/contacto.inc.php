        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>Contactos</h2>
              <p>Contactanos con nosotros y obten mas informacion sobre la carrera de Matematicas y/o mandanos un correo aquí.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row gy-4 mt-4">
          ...
          <div class="col-lg-4">
            ...
            <div class="info-item d-flex">
              ...
              <div>
                <h4>Location:</h4>
                <p>Dirección: Av. Villazón Nº 1995, Plaza del Central, La Paz - Bolivi</p>
              </div>
            </div><!-- End Info Item -->
          ...
          <div class="col-lg-8">
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              ...
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="subject" id="subject" placeholder="Rázon" required>
              </div>
              <div class="form-group mt-3">
